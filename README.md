...
<h3 align="center">🚀 Full Stack Developer | Tech Enthusiast | B.Tech CSE @ GIET</h3>

<p align="center">
  <a href="https://github.com/MERN-Web-Suman">
...
**Backend & DB**  
`Node.js` `Express.js` `MongoDB` `MySQL` `Mongoose`

**DevOps & Tools**  
`Git & GitHub` `Postman` `Render` `Vercel` `Netlify`

**Other Skills**  
`Redux` `REST API` `Context API` `JWT Auth` `Axios` `Bcrypt` `CORS`
...
<a href="mailto:sumankumar9798330493@gmail.com" target="_blank">
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=mern-web-suman&show_icons=true&theme=default" alt="GitHub Stats" />
  <br/>
